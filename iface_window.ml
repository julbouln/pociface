...
class iface_window drawing_vault (rid:string) (tipa) (tipa_min) (bgpa) fnt_t tcol (clgr) (mingr) (maxgr) ttxt (c:iface_object)=
object(self)
  inherit iface_object 0 0 as super
  val mutable content=c

  val mutable tilab=new iface_label_static drawing_vault fnt_t tcol ttxt 
